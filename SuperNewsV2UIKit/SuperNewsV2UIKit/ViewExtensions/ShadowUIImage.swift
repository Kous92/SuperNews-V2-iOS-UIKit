...
extension UIView {
    ...
    func setViewShadow(color: CGColor = UIColor.black.cgColor, offset: CGSize = CGSize(), radius: CGFloat, opacity: Float, boundsToDrawShadowPath: CGRect, cornerRadius: CGFloat) {
