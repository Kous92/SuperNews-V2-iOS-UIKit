...
L'application est disponible à l'essai via **TestFlight** en **[cliquant ici]()**. Un iPhone ou un iPad sous iOS/iPadOS 15.0 ou plus est requis.
...
This app is available for testing with **TestFlight**, **[click here to test]()**. An iPhone or iPad under iOS/iPadOS 15.0 or later is required.